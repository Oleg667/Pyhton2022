# ввод количество билетов
n_tiket=abs(int(input('Введите количество поситителей = ')))
...
if len(L_age)<n_tiket: # если список возрастов меньше количества билетов, то остаток по полному тарифу
    ...
    while i<=n_tiket-len(L_age):
        L_age.append(26)
        i+=1
elif len(L_age)>n_tiket: # если список возрастов  количества билетов, то лишнии удаляются с конца списка
    i = 0
