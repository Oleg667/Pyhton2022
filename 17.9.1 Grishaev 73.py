...
if numeral <= array_sort[0]:
    ...
    n=1
    if numeral==array_sort[numeral_in-1]: #обработка ситуации когда введенное число совпадает с элементом списка
        n=2
    print(f'\nномер позиции элемента, который меньше введенного числа,\n а следующий за ним больше или равен этому числу.:', (numeral_in-n))
